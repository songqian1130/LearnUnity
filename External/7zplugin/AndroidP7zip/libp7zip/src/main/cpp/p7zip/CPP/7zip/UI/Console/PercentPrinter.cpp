...
extern jmethodID sOnPercent;
extern JNIEnv* sEnv;
extern jobject sCallback;
...
void CPercentPrinter::GetPercents()
{
  ...
  _s += s;
  //__android_log_print(ANDROID_LOG_WARN,"7z:","%s",_s.Ptr());
    //sEnv->CallVoidMethod(sCallback,sOnPercent,_s.Ptr());
    CallJavaStringMethod(sEnv,sCallback,sOnPercent,(char*)_s.Ptr());
}
